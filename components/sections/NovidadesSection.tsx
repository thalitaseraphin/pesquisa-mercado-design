...
const news = [
  {
    href: "https://www.figma.com/blog/gpt-5-6-is-now-available-in-figma-make/",
    tag: "Ferramenta",
    tagClass: "bg-[#2563EB] text-white",
    date: "Jul 2026",
    reportDate: "28/07/2026",
    title: "Figma Make ganha o modelo GPT-5.6 da OpenAI, com builds mais rápidos e fiéis ao design original",
    desc: "Anunciado em 09/07/2026: segundo o Figma Blog, a integração do <strong>GPT-5.6</strong> eleva qualidade e velocidade da primeira geração de protótipos no Figma Make — UI limpa, layouts responsivos e interações de alta fidelidade a partir de um único prompt, com maior eficiência de tokens e recuperação automática quando um build quebra ('self-healing'). Já disponível em todos os planos. Mostra que a Figma segue somando modelos de terceiros ao seu próprio Figma agent, em vez de depender de um único modelo proprietário.",
    source: "Figma Blog — GPT-5.6 is Now Available in Figma Make",
  },
  {
    href: "https://news.adobe.com/news/2026/06/adobe-and-disney-imagineering-collaborate",
    tag: "Ferramenta",
    tagClass: "bg-[#2563EB] text-white",
    date: "Jun 2026",
    reportDate: "28/07/2026",
    title: "Adobe e Walt Disney Imagineering integram o Firefly Foundry ao design de parques temáticos",
    desc: "Parceria anunciada em 06/2026: a Adobe treinou um modelo de IA generativa privado — <strong>Firefly Foundry</strong> — sobre os ativos proprietários da Disney (Mickey & Friends, Frozen, Moana, Lilo & Stitch, Cars), construído sobre os modelos-base comercialmente seguros do Firefly. A capacidade de modelagem 3D transforma renderizações 2D em protótipos 3D detalhados, acelerando o pipeline de design e pré-produção dos Disney Parks and Experiences antes do início da obra física. Caso concreto de adoção enterprise de IA generativa customizada em um fluxo de design de altíssimo orçamento.",
    source: "Adobe Newsroom — Adobe and Disney Imagineering Collaborate",
  },
  {
    ...
    date: "Jan 2026",
    reportDate: "28/07/2026",
    title: "Nielsen Norman Group: 'UI não é mais um diferencial' — State of UX 2026",
    desc: "Publicado em 16/01/2026, o relatório anual da NN/g traz três teses para 2026: o mercado de trabalho de UX está <strong>'estabilizando, mas ainda competitivo'</strong> (cargos seniores/generalistas se recuperam mais rápido que os de entrada); organizações vão <strong>'pedir mais de cada função'</strong>, comprimindo responsabilidades antes distribuídas entre especialistas; e a tese central — <strong>'UI não é mais um diferencial'</strong> — à medida que design systems padronizam a interface e a IA passa a mediar mais interações, o valor do trabalho de UX migra da tela para pesquisa, julgamento crítico e 'taste'.",
    source: "Nielsen Norman Group — State of UX 2026: Design Deeper to Differentiate",
  },
  {
    href: "https://techcrunch.com/2026/07/06/the-running-list-major-tech-layoffs-in-2026-where-employers-cited-ai/",
    tag: "Mercado",
    tagClass: "bg-[#F6F8FB] text-[#434A57] border border-[#D2D9E4]",
    date: "Jul 2026",
    reportDate: "28/07/2026",
    title: "Coinbase testa 'times de uma pessoa só' (design + engenharia + produto) em corte de vagas ligado a IA",
    desc: "Ao anunciar o corte de ~700 funcionários (14% do quadro) em 05/05/2026, a Coinbase achatou sua estrutura organizacional e disse que vai experimentar <strong>'times de uma pessoa só'</strong> combinando engenharia, design e produto — o CEO Brian Armstrong citou que 'engenheiros usam IA para entregar em dias o que antes levava semanas de equipe'. Exemplo pontual (não estatística de mercado), mas evidência corporativa concreta da 'compressão de papéis' já mapeada neste documento. Contexto mais amplo: cerca de 120 mil vagas de tecnologia foram cortadas em 2026 até julho, segundo o tracker Layoffs.fyi, citado na mesma matéria da TechCrunch.",
    source: "TechCrunch — The running list: major tech layoffs in 2026 where employers cited AI",
  },
  {
